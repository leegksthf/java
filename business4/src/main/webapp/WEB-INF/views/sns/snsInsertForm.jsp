...
<div class="col-md-12 text-center mb-5">
	...
	<div>
	<form id="frm" name="frm" action="insertSns.do" method="post">
	<div>
		<table border="1">
			<tr>
				<th width="100">작성자</th>
				<td width="150" ><input type="text" id="sWriter" name="sWriter" required="required" value="${name }" ></td>
				<th width="100">작성일자</th>
				<td width="150"><input type="date" id="sDate" name="sDate"></td>
			</tr>
			<tr>
				<th width="100">글제목</th>
				<td colspan="3"><input type="text" id="sTitle" name="sTitle" size="60" required="required"></td>
			</tr>
			<tr>
				<th width="100">내용</th>
				<td colspan="3">
					<textarea rows="7" cols="65" id="sContents" name="sContents" required="required" placeholder="여기다 내용을 써 주세요"></textarea>
				</td>
			</tr>
		</table>	
	</div><br/>
