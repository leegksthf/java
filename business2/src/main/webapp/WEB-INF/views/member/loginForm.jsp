						...
						<form action="#" method="post" class="bg-white">
							...
							<div class="">
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_fid" class="text-black"> ID <span
											class="text-danger">*</span></label> <input type="number"
											class="form-control" id="c_id" name="c_id">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_pass" class="text-black">password <span
								...
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_name" class="text-black">name <span
								...
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_email" class="text-black">e-mail <span
